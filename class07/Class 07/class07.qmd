...
> Q. From your results object 'k' how many points are in each cluster?
...
points(k$center, col="blue", pch=15, cex=2)
```
...
We are after the 'pca$x' result componenet to make our main PCA plot. 
